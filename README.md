...
* Хранить саму сим-карту в надёжном месте [^1]
 ...
 * в менеджере паролей
 * в каком-то онлайн аккаунте, существование которого держится в секрете (и использование этого аккаунта не сохранено в браузере)

...
* Если Вы устанавливаете опцию телеграм "Cинхронизировать контакты", то Ваши контакты из телеграм копируются в Ваш аккаунт gmail. Таким образом, даже после выхода из аккаунта Телеграм или после удаления приложения, Ваши контакты можно увидеть в аккаунте gmail через телефон или компьютер.

...
* Кажется Телеграм очень сложно заблокировать, вот что пишут:
  + вроде бы его пытались заблокировать в России, Иране, Афганистане и Китае, но
    - полного блокирования не удалось достичь нигде
    - с замедлением / через VPN-сервисы / частные сети и "серые" клиенты Телеграм продолжает работать

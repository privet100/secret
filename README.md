...
* Сохранение всей этой информации на серверах Телеграм
  ...
  + Телеграм НЕ может сообщать инфомрацию из секретных чатов (она не сохраняется на серверах)
* Кажется Телеграм очень сложно заблокировать, вот что пишут:
  + вроде бы его пытались заблокировать в России, Иране, Афганистане и Китае, но полного блокирования не удалось достичь нигде, с замедлением / через VPN-сервисы / частные сети и "серые" клиенты Телеграм продолжает работать
